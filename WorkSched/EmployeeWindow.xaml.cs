...
namespace WorkSched
{
    public partial class EmployeeWindow : Window
    {
        ...
        private async void OnLeaveSubmit(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Заполните тип и даты заявки.", "Внимание", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                    ...
                    VALUES(@e, @t, N'Pending', @s, @e2, @r)", conn))
                {
                    ...
                    cmd.Parameters.Add("@r", SqlDbType.NVarChar, 200).Value = string.IsNullOrWhiteSpace(reason) ? DBNull.Value : (object)reason;
                ...
                MessageBox.Show("Заявка успешно отправлена на рассмотрение!", "Успех", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
